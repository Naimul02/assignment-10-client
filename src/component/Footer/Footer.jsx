const Footer = () => {
  return (
    <div className="">
      <footer className="footer px-20 py-10  bg-green-950 text-neutral-content">
        <aside>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjfytcdSfVqcFfrz6z9F3fQMjuQdIVyJ6oD0pd3dGaEu5l_2-fngcLQqv9ricNcapXF7U&usqp=CAU"
            alt=""
